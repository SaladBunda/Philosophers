...
/*   Updated: 2024/06/22 19:37:07 by ael-maaz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*main_thread(void *fo)
{
	...
	while (1/* info->status == 0 *//*  && info->done_eating == 0 */)
	{
		...
		// {
			...
			// sem_wait(info->data->done_meals);
     	//    if (info->data->done_eating == 1)
      	// 	  {
        //     sem_wait(info->data->print);
...
void	*routine(void *info)
{
	...
	while (1)
	{
		// if (info_cast->data->done_eating == 1 )
		// 	break ;
		...
		// 	break ;
        // if (info_cast->times_eaten <= info_cast->data->t_to_eat && info_cast->data->t_to_eat != -1)
        // {
        //     sem_wait(info_cast->data->meal_count);
        // }

		// if (info_cast->data->t_to_eat != -1)
        // {
        //     int expected_meals = info_cast->data->num * info_cast->data->t_to_eat;
        //     for (int i = 0; i < expected_meals - 1; i++)
        //     {
        //         sem_post(info_cast->data->done_meals);
        //     }
        // }
		// if (info_cast->data->done_eating == 1)
        //     break;
...
int	main(int ac, char **av)
{
	...
	if (ac == 5 || ac == 6)
	{
		...
		// pthread_create(&info.food_monitor,NULL,monitor_food, &info);
